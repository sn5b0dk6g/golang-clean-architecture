...
import "go-rest-api/adapter/logger"
...
func (l LoggerMock) WithIndexFields(_ logger.Fields, indexs ...string) logger.Logger {
...
func (l LoggerEntryMock) WithIndexFields(_ logger.Fields, indexs ...string) logger.Logger {
	return LoggerEntryMock{}
}
